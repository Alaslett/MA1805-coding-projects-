let i = 0;
// Text obtained from the UK Government website 
...
const textArray = housingText.split(" ");
//Convert the text into an array (list) of windowResized.apply

function setup(){
  createCanvas (500,500);
frameRate(10); // speed of sketch
}
function draw () {
let x = random(width)
let y = random(height);
...
if (i < textArray.length)
  { // is i less-than the number of words in the text
    ...
    background(255); //clear rhe background
}
